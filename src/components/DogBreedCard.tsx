...
const DogBreedCard = ({ dogBreed }: Props) => {
  return (
    <Card className='card-front'>
      <Image height='50%' className="dog-image" src={dogBreed.image_link} />
      <CardBody height='50%' textAlign='center' display='flex' flexDirection='column' justifyContent='space-between'>
        ...
        <div>
          <HStack marginTop={5} justifyContent='space-between'>
            ...
            <Text fontSize={18}>{dogBreed.min_life_expectancy}-{dogBreed.max_life_expectancy} years</Text>
          </HStack>
          <HStack marginTop={1} justifyContent='space-between'>
            <Text fontSize={18}>Weight (female) </Text>
            <Text fontSize={18}>{dogBreed.min_weight_female}-{dogBreed.max_weight_female} pounds</Text>
          </HStack>
          <HStack marginTop={1} justifyContent='space-between'>
            <Text fontSize={18}>Weight (male) </Text>
            <Text fontSize={18}>{dogBreed.min_weight_male}-{dogBreed.max_weight_male} pounds</Text>
          </HStack>
          <HStack marginTop={1} justifyContent='space-between'>
            <Text fontSize={18}>Height (female) </Text>
            <Text fontSize={18}>{dogBreed.min_height_female}-{dogBreed.max_height_female} inches</Text>
          </HStack>
          <HStack marginTop={1} justifyContent='space-between'>
            <Text fontSize={18}>Height (male) </Text>
            <Text fontSize={18}>{dogBreed.min_height_male}-{dogBreed.max_height_male} inches</Text>
          </HStack>
        </div>
      </CardBody>
    </Card>
